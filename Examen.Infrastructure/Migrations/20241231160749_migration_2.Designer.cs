...
namespace Examen.Infrastructure.Migrations
{
    ...
    [Migration("20241231160749_migration_2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Examen.ApplicationCore.Domain.Client", b =>
                {
                    b.OwnsOne("Examen.ApplicationCore.Domain.Coordonnees", "Coordonnes", b1 =>
                        {
            ...
            modelBuilder.Entity("Examen.ApplicationCore.Domain.Prestataire", b =>
                {
                    b.HasOne("Examen.ApplicationCore.Domain.Specialite", "MySpecialite")
            ...
            modelBuilder.Entity("Examen.ApplicationCore.Domain.Prestation", b =>
                {
                    b.HasOne("Examen.ApplicationCore.Domain.Client", "MyClient")
                        .WithMany("Prestations")
                        .HasForeignKey("ClientFK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Examen.ApplicationCore.Domain.Prestataire", "MyPrestataire")
                        .WithMany("Prestations")
